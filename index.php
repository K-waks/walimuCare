        ...
        <header id="header">
            <div class="container-fluid header-nav">
                <div class="clearfix position-relative h-100">
                    ...
                    <img src="static/img/icon/TSC.png"
                         width=""
                         height="90%"
                         alt=""
                         class="float-end">
                    <!-- Desktop Navigation -->
                    <div class="d-none d-md-flex desktop-nav">
                    ...
                    <div class="d-flex d-md-none mobile-nav-btn">
                        <button type="button"
                                class="btn btn-primary d-md-none d-inline-block"
                            ...
                            <div class="services-icons rounded-2 user-select-none">
                                <div class="row row-cols-2 row-cols-sm-4 g-3">
                                    <div class="col" data-aos="flip-left">
                                        <a href="benefits-structure.html?benefits=wellness&category=maternity">
                                            <img src="static/img/service/Maternity.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="100">
                                        <a href="benefits-structure.html?benefits=wellness&category=optical">
                                            <img src="static/img/service/Optical.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="200">
                                        <a href="benefits-structure.html?benefits=wellness&category=dental">
                                            <img src="static/img/service/Dental.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="300">
                                        <a href="benefits-structure.html?benefits=wellness&category=evacuation">
                                            <img src="static/img/service/RoadEvacuation.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="400">
                                        <a href="benefits-structure.html?benefits=wellness&category=international-treatment">
                                            <img src="static/img/service/InternationalTravel.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="500">
                                        <a href="benefits-structure.html?benefits=wellness&category=evacuation">
                                            <img src="static/img/service/AirEvacuation.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="600">
                                        <a href="benefits-structure.html?benefits=wellness&category=psychiatric-counsellings">
                                            <img src="static/img/service/Psychiatric&Counselling.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                                    ...
                                    <div class="col" data-aos="flip-left" data-aos-delay="700">
                                        <a href="benefits-structure.html?benefits=wellness&category=last-respects">
                                            <img src="static/img/service/LastRespects.png"
                                                 width=""
                                                 height=""
                                                 alt=""
                                                 class="img-fluid shadow">
                    ...
                    <div class="swiper" data-aos="zoom-in">
                        <div class="swiper-wrapper align-items-center user-select-none">
                            <div class="swiper-slide">
                                <img src="static/img/client/minetlogo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Minet logo">
                            ...
                            <div class="swiper-slide">
                                <img src="static/img/client/Bliss-healthcare-logo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Bliss Healthcare logo">
                            </div>
                            <div class="swiper-slide">
                                <img src="static/img/client/Pioneer-Assurance-logo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Pioneer Assurance logo">
                            </div>
                            <div class="swiper-slide">
                                <img src="static/img/client/cicinsurance-logo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                            ...
                            <div class="swiper-slide">
                                <img src="static/img/client/old-mutual-logo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Old Mutual logo">
                            ...
                            <div class="swiper-slide">
                                <img src="static/img/client/Britam-Logo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Britam logo">
                            ...
                            <div class="swiper-slide">
                                <img src="static/img/client/makllogo.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Medical Administrator Kenya Ltd logo">
                            </div>
                            <div class="swiper-slide">
                                <img src="static/img/client/star-discover-general-insurance.png"
                                     class="img-fluid"
                                     width=""
                                     height=""
                                     alt="Star Discover General Insurance logo">
                            </div>
                        </div>
                ...
                <div class="container-fluid section-padding">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
                        <div class="col" data-aos="fade-up">
                            ...
                            <a href="benefits-structure.html?benefits=inpatient">Read More <i class="bi bi-chevron-right"></i></a>
                        </div>
                        <div class="col" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <a href="benefits-structure.html?benefits=outpatient">Read More <i class="bi bi-chevron-right"></i></a>
                        </div>
                        <div class="col" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <a href="benefits-structure.html?benefits=additional-cover">Read More <i class="bi bi-chevron-right"></i></a>
                        </div>
                        <div class="col" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <a href="benefits-structure.html?benefits=wellness">Read More <i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </section>
