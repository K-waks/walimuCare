                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-unstyled">
                            <li class="nav-item">
                                <a href="index.php" class="nav-link active"><i class="bi bi-caret-right-fill"></i> Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="county-offices.php" class="nav-link"><i class="bi bi-caret-right-fill"></i> County Offices</a>
                            </li>
                            <li class="nav-item">
